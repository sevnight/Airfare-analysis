...
pred = res.get_prediction(start=pd.to_datetime('2018-08-21'), 
                          end=pd.to_datetime('2018-11-17'),
                          dynamic=True)
pred_ci = pred.conf_int()
 
# plot in-sample-prediction
ax = y['2018-05-25':].plot(label='Observed',color='#006699')
...
# style the plot
ax.fill_betweenx(ax.get_ylim(), pd.to_datetime('2018-08-21'), y.index[-1], alpha=.15, zorder=-1, color='grey')
ax.set_xlabel('Date')
ax.set_ylabel('Price')
...
pred_out = res.get_prediction(start=pd.to_datetime('2018-08-21'), 
                              end=pd.to_datetime('2018-11-17'), 
...
pred_uc = res.get_forecast(steps=56)
